...
Source0  : https://download.gnome.org/sources/gnome-boxes/47/gnome-boxes-47.0.tar.xz
...
BuildRequires : libvirt-glib-dev
...
%description
libgovf is a library for reading and writing virtual machine images in the Open Virtualization Format.
...
%prep
%setup -q -n gnome-boxes-47.0
cd %{_builddir}/gnome-boxes-47.0
%patch -P 1 -p1
pushd ..
cp -a gnome-boxes-47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726759305
...
/usr/share/gnome-boxes/osinfo/os/manjaro.org/manjaro-rolling.xml
...
/usr/share/gnome-boxes/osinfo/os/trisquel.info/trisquel-9.xml
...
/usr/share/metainfo/org.gnome.Boxes.metainfo.xml
