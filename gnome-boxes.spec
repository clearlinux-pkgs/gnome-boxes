...
Source0  : https://download.gnome.org/sources/gnome-boxes/43/gnome-boxes-43.3.tar.xz
...
%prep
%setup -q -n gnome-boxes-43.3
cd %{_builddir}/gnome-boxes-43.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676396797
