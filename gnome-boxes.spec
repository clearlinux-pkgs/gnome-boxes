...
Version  : 48.0
Release  : 51
URL      : https://download.gnome.org/sources/gnome-boxes/48/gnome-boxes-48.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-boxes/48/gnome-boxes-48.0.tar.xz
...
%prep
%setup -q -n gnome-boxes-48.0
cd %{_builddir}/gnome-boxes-48.0
%patch -P 1 -p1
pushd ..
cp -a gnome-boxes-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742603263
