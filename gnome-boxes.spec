...
Version  : 43.1
Release  : 39
URL      : https://download.gnome.org/sources/gnome-boxes/43/gnome-boxes-43.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-boxes/43/gnome-boxes-43.1.tar.xz
...
%prep
%setup -q -n gnome-boxes-43.1
cd %{_builddir}/gnome-boxes-43.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666825912
...
/usr/share/help/zh_CN/gnome-boxes/shortcuts.page
