...
Version  : 3.36.4
Release  : 11
URL      : https://download.gnome.org/sources/gnome-boxes/3.36/gnome-boxes-3.36.4.tar.xz
Source0  : https://download.gnome.org/sources/gnome-boxes/3.36/gnome-boxes-3.36.4.tar.xz
...
%prep
%setup -q -n gnome-boxes-3.36.4
cd %{_builddir}/gnome-boxes-3.36.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590595491
...
cp %{_builddir}/gnome-boxes-3.36.4/COPYING %{buildroot}/usr/share/package-licenses/gnome-boxes/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/gnome-boxes-3.36.4/copyright %{buildroot}/usr/share/package-licenses/gnome-boxes/a4c835de9e0708234c05f918157e7b47ac65cde7
cp %{_builddir}/gnome-boxes-3.36.4/subprojects/gtk-frdp/COPYING %{buildroot}/usr/share/package-licenses/gnome-boxes/a8a12e6867d7ee39c21d9b11a984066099b6fb6b
cp %{_builddir}/gnome-boxes-3.36.4/subprojects/libovf-glib/COPYING %{buildroot}/usr/share/package-licenses/gnome-boxes/3704f4680301a60004b20f94e0b5b8c7ff1484a9
