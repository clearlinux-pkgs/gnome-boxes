...
Version  : 43.2
Release  : 40
URL      : https://download.gnome.org/sources/gnome-boxes/43/gnome-boxes-43.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-boxes/43/gnome-boxes-43.2.tar.xz
...
%prep
%setup -q -n gnome-boxes-43.2
cd %{_builddir}/gnome-boxes-43.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672074900
